...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h1 class="mb-4">Tambah Inventory Stock</h1>

            <card>
                <form action="{{ route('inventory-stocks.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control @error('kuantitas') is-invalid @enderror" 
                               id="kuantitas" name="kuantitas" value="{{ old('kuantitas') }}" required min="0">
                        @error('kuantitas')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('nilai_avg_cost') is-invalid @enderror" 
                               id="nilai_avg_cost" name="nilai_avg_cost" value="{{ old('nilai_avg_cost') }}" required min="0">
