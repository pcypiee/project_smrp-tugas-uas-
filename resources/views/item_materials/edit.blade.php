        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Item Material</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('item-materials.update', $itemMaterial->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="nama_item" 
                                   name="nama_item" 
                                   value="{{ old('nama_item', $itemMaterial->nama_item) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="unit_satuan" 
                                   name="unit_satuan" 
                                   value="{{ old('unit_satuan', $itemMaterial->unit_satuan) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="rop" 
                                   name="rop" 
                                   value="{{ old('rop', $itemMaterial->rop) }}"
